...
namespace Netdust\VAD\Modules\GeoSearch\Post;
...
class Bootstrap
{
    ...
    public function __construct()
    {
        ...
        add_filter('fluentform_global_addons', function ($addons) use ($isEnabled) {
            ...
            $addons['ficheFeeds'] = [
                'title' => 'DVG Fiche Creation',
                'category' => 'wp_core',
                'description' => 'Create DWG fiche on form submission. ',
    ...
    protected function registerHooks()
    {
        ...
        add_action('fluentform_form_element_start', [
    ...
    private function isEnabled()
    {
        ...
        if ($globalModules) {
            return ArrayHelper::get($globalModules, 'ficheFeeds') == 'yes';
        }
