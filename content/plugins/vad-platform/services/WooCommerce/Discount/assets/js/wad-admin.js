...
//                    },
        ...
        $(document).on("change", "input[type=radio][name='o-discount[type]']", function (e)
        {
            display_proper_discount_fields();
        });


        function display_proper_discount_fields()
        {
            var discount_type = $('input[type=radio][name="o-discount[type]"]:checked').attr('value');

            if (discount_type == 'coupon') {
                $("#coupon_rules").parent().parent().show();
                $("#steps_rules").parent().parent().hide();
                $("#intervals_rules").parent().parent().hide();
                $("input[type=radio][name=\"o-discount[rules-type]\"]").closest('tr').hide();

            } else {
                $("#coupon_rules").parent().parent().hide();
                $("#intervals_rules").parent().parent().hide();
                $("#steps_rules").parent().parent().hide();
                $("input[type=radio][name=\"o-discount[rules-type]\"]").closest('tr').show();
...
//        });
        ...
        {
            var selected_value = $(this).val();
            if (selected_value == "percentage-off-pprice" || selected_value == "fixed-amount-off-pprice")//Product based actions
            {
                $(".free-gift-row").hide();
